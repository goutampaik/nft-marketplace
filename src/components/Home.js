      ...
      <section>
        <div className="live-action">
          <div className="container">
            ...
            <div className="live-collection-inner cpy-5">
              <div className="row">
      ...
      <section>
        <div class="popular-collection">
          <div class="container">
            ...
            <div class="popular-cat-inner cpy-5">
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="popular-cat-item">
                    <div class="collection-top">
                      <div class="popular-cat-image">
                        <img src="assets/img//collection/1.png" alt="" />
                      </div>
                      <div class="popular-cat-details">
                        <h4>
                          <a href=""> Radium Animated Monster </a>
                        </h4>
                        <p>Collection Has 13 Item</p>
                      </div>
                    </div>

                    <div class="cat-owner-details">
                      <div class="owner-left">
                        <div class="cat-owner-image">
                          <img src="assets/img/user/1.png" alt="" />
                        </div>
                        <div class="cat-owner-name">
                          <a href="" class="owner-name">
                            {" "}
                            Daniel M. Bivens{" "}
                          </a>
                          <p class="author-title">Creator</p>
                        </div>
                      </div>
      ...
      <section>
        <div class="popular-cat">
          <div class="container">
            ...
            <div class="popular-category-inner cpt-5">
              <div class="row">
