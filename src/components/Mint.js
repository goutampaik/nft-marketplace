    ...
    <section className="mint" data-aos="flip-right">
      <div className="marqu">
        <Marquee speed="50" pauseOnHover="true">
          <div className="belt-box">
            ...
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-1.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-2.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-3.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-4.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-5.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-6.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-7.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-8.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
              <div className="img-1">
                <img src="./images/belt-9.png" alt="Slider Images" />
              </div>
            </div>
            {/* Step  */}
            <div className="box-1">
      ...
      <div className="container">
        <div className="total-minted">
          <p>TOTAL MINTED: 3380 / 5000</p>
          <p>0.05 ETH + GAS FEE</p>
          <p>MAX 10 ULB NFTs PER TRANSACTION</p>
        </div>
        <div className="gas">
          <span
            className="minus"
